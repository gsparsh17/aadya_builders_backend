...
class UserService {
  ...
  async updatePreferences(userId, preferences) {
    ...
    const currentPrefs = user.preferences?.toObject() || {
      preferredLocations: [],
      propertyTypes: [],
    ...
    if (!Array.isArray(user.preferences.preferredLocations)) {
      user.preferences.preferredLocations = [];
    }
    if (!Array.isArray(user.preferences.propertyTypes)) {
      user.preferences.propertyTypes = [];
    }
    if (!Array.isArray(user.preferences.preferredConfigurations)) {
      user.preferences.preferredConfigurations = [];
    }
